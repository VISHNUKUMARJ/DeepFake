...
# Wrap the DeepFace import in a try/except block
...
try:
    ...
    print("Will use fallback detection only")
...
def check_fake_image(image_path):
    ...
    # Skip DeepFace if it's not available
    if not deepface_available:
        return fallback_fake_detection(image_path, error="DeepFace not available in this environment")
